  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              {/* Reviews */}
              <div className="mt-6">
                <Typography component="legend"> Product Ratings </Typography>
                <div className="flex items-center space-x-3">
                  <Rating name="read-only" value={4} readOnly />
                  <p className="opacity-50 text-sm "> 5000 Ratings </p>
                  <p className="ml-3  text-sm font-medium text-indigo-600 hover:text-green-400 ">
                    {" "}
                    7000 Reviews{" "}
                  </p>
                </div>
              ...
              <form className="mt-10">
                ...
                <Button
                  type="submit"
                  className="text-xl bg-indigo-800 "
                  color="secondary"
                  variant="contained"
                  sx={{ px: "rem", py: "1rem" }}
        ...
        <section>
          <hl className="font-semib01d text-lg pb-4">Recent Review & Rating</hl>
          npm s
          <div className="border p-5">
            <Grid container spacing={7}>
              <Grid item xs={7}>
                <div className="flex flex-col gap-8 space-y-5">
                  {[1, 1, 1, 1, 1].map(() => (
                    <ProductReviewCard />
                  ))}
                </div>
              ...
              <Grid item xs={5}>
                <h1 className="text-xl font-semibold pb-5"> Product Ratings</h1>
                <div className="flex items-center space-x-3">
                  <Rating value={4} precision={0.5} readOnly />
                  <p className="opacity-50">5000 Ratings</p>
                </div>
        ...
        <section className="pt-1o">
          <h1 className="py-5 text-xl font-bold"> Simular Products </h1>
